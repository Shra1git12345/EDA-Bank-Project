...
Data Understanding
The data set  contains the complete loan data for all loans issued from 2007 to 2011.
You can access the data dictionary that describes the meaning of these variables from the document provided .
